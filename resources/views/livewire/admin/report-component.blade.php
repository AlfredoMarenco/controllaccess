    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="underline-offset-1 mx-auto font-semibold p-4 cursor-pointer hover:text-blue-700">
                    @if ($principal)
                        <h1 wire:click="showInterior()">Ver acceso interior</h1>
                    @else
                        <h1 wire:click="showPrincipal()">Ver acceso principal</h1>
                    @endif
                </div>
                @if ($principal)
                <h1 class=" text-center font-semibold text-3xl text-red-600">Filtro Principal</h1>
                    <div class="px-4 pb-4 mb-4 shadow-xl bg-white">
                        <div class="grid lg:grid-cols-5 lg:gap-8 grid-cols-1 gap-2 place-content-center p-4">
                            @foreach ($boxs as $palco)
                                <div>
                                    <h1 class="text-center font-bold p-2">PALCO {{ $palco->name }}
                                        {{ $palco->identifier }}</h1>
                ...
                @else
                <h1 class=" text-center font-semibold text-3xl text-blue-600">Filtro Interior</h1>
                    <div class="px-4 pb-4 mb-4 shadow-xl bg-white">
                        <div class="grid lg:grid-cols-5 lg:gap-8 grid-cols-1 gap-2 place-content-center p-4">
                            @foreach ($boxs as $palco)
                                <div>
